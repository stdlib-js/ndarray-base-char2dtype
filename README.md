...
```javascript
import char2dtype from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-char2dtype@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-char2dtype/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/ndarray-base-char2dtype/actions/workflows/test.yml?query=branch:v0.2.2
